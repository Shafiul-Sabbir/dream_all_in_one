...
class GeneralSetting(models.Model):
    ...
    favicon = models.ImageField(upload_to=partial(get_image_upload_folder, subfolder="site_settings/company_logos/"), null=True, blank=True)
    cloudflare_favicon = models.URLField(max_length=500, null=True, blank=True)
    
    logo = models.ImageField(upload_to=partial(get_image_upload_folder, subfolder="site_settings/company_logos/"), null=True, blank=True)
    cloudflare_logo = models.URLField(max_length=500, null=True, blank=True)
    
    footer_logo = models.ImageField(upload_to=partial(get_image_upload_folder, subfolder="site_settings/company_logos/"), null=True, blank=True)
    cloudflare_footer = models.URLField(max_length=500, null=True, blank=True)
    
    slider = models.ImageField(upload_to=partial(get_image_upload_folder, subfolder="site_settings/company_logos/"), null=True, blank=True)
...
class HomePageSlider(models.Model):
    ...
    image = models.ImageField(upload_to=partial(get_image_upload_folder, subfolder="site_settings/home_page_slider/"), null=True, blank=True)
