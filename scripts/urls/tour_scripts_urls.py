...
urlpatterns = [
    ...
    path('api/v1/load_tour_content_image_for_exceptional_case/<int:company_id>/', views.load_TourContentImage_for_exceptional_case), 
    ...
    path('api/v1/load_tour_itinerary_for_it_and_uk/<int:company_id>/', views.load_TourItinerary_for_it_and_uk),
    ...
    path('api/v1/load_thumbnail_image/<int:company_id>/', views.load_thumbnail_image), 

    path('api/v1/load_meta_data/<int:company_id>/', views.load_meta_data), 
