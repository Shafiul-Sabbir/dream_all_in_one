...
def get_company_from_email(company_name):
    ...
    if IS_LOCAL:
        ...
        return email_map.get(company_name, "sales@dreamziarah.com")


# ----------------------------
# 1. Date Change Request To Admin
# ----------------------------
def send_date_change_request_email_to_admin(tour_booking, admin_all_booking_page_url):
    ...
    if IS_LOCAL:
        ...
        # Live এ company অনুযায়ী to address set করা
        to_email_map = {
            "IT": "sales@dreamtourism.it",
            "UK": "sales@dreamtourism.co.uk",
            "ZIARAH": "sales@dreamziarah.com"
        }
        to = [to_email_map.get(company)]
        bcc = ["rakib.islam0000@gmail.com", "mazumdermdashiq@gmail.com", from_email]
...
def send_date_change_request_approval_email_from_admin_to_traveller(tour_booking, traveller_dashboard_url):
    ...
    ticket_pdf_bytes = HTML(string=changed_ticket_html).write_pdf(
...
# ----------------------------
# 4. Booking Cancellation Request To Admin
# ----------------------------
...
# ----------------------------
# 5. Booking Cancellation Request Approval
# ----------------------------
...
# ----------------------------
# 6. Booking Cancellation Request Deny
# ----------------------------
...
# ----------------------------
# 7. Manual Cancellation of Booking by Admin
# ----------------------------
